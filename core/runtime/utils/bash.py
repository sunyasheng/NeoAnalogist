...
from core.events.observation.commands import (CMD_OUTPUT_PS1_END,
                                              CmdOutputMetadata,
...
class BashSession:
    ...
    def initialize(self):
        ...
        if self.username in ['root', 'yashengsun']:
        ...
        session_name = f'gpt-scientist-{self.username}-{uuid.uuid4()}'
