...
class ActionExecutor:
    ...
    async def got_edit(self, action: GoTEditAction) -> GoTEditObservation:
        """Call GoT API to edit an image with a prompt.
        ...
        try:
            ...
            # Always use the specified output_path if provided, otherwise use GoT's returned path
            if action.output_path:
                if image_paths:
                    # Copy from GoT's path to our specified path
                    try:
                        ...
                        # Use our specified path in the observation
                    ...
                    # No image generated, use our specified path anyway
                    image_paths = [action.output_path]
