...
# Note: Assuming 'core.logger' exists or will be created.
# If not, this might need to be adjusted to a valid logger import.
...
class View(BaseModel):
    ...
    def from_events(events: list[Event]) -> View:
        ...
        if summary is not None and summary_offset is not None:
            print(f'Inserting summary at offset {summary_offset}')
