...
class CmdOutputObservation(Observation):
    ...
    def to_agent_observation(self) -> str:
        # Filter and truncate content to prevent memory explosion
        filtered_content = self._filter_and_truncate_output(self.content)
        ret = f"{self.metadata.prefix}{filtered_content}{self.metadata.suffix}"
    ...
    def _filter_and_truncate_output(self, output: str, max_lines: int = 1000, max_chars: int = 20000) -> str:
        ...
        max_progress_bars = 2  # Limit progress bar lines for command output
